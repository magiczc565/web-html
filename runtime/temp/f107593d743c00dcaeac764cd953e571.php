<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\wamp\www\ydwxfx\public/../app/index\view\index\shopitems.html";i:1526472575;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                    ...
                    if (activeArray.length != ul_items.length) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (obj.code == '0') {
                                    alert('下单成功');
//                                window.location.href="http://localhost/ydwxfx/public/index.php/index/index/";
                                }
                            },
                            error: function () {
                                alert('error');
