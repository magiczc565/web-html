<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"E:\phpstudy\PHPTutorial\WWW\ydwxfx2\public/../app/index\view\index\shopcat.html";i:1526806526;}*/ ?>
﻿<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <script type="text/javascript" src="/ydwxfx2/public/static/js//shopping.js"></script>
    <script src="/ydwxfx2/public/static/js/common.js"></script>
    <script src="/ydwxfx2/public/static/js/jquery.min.js" type="text/javascript"></script>
    <script src="https://cdn.jsdelivr.net/npm/vue"></script>
    <link type="text/css" rel="stylesheet" href="/ydwxfx2/public/static/css/base.css"/>
    <link type="text/css" rel="stylesheet" href="/ydwxfx2/public/static/css/module.css"/>

</head>
<body>
<div class="header">
    <h1>购物车</h1>
    <a href="/ydwxfx2/public/index/index/index" class="back"><span></span></a>
    <a href="#" class=""></a>
</div>
<!--头部结束-->
...
//                    window.location.href="";
            ...
            doAddCart:function () {
                ...
                if(id_count.length>0){
                    $.ajax({
                        url: "http://localhost/pcwxa  pi/public/index.php/user/user/createOrder",
                        data: {
                            catString: id_count,
                            user_id: "<?php echo $data['user_id']; ?>",
                            user_token: "<?php echo $data['token']; ?>"
